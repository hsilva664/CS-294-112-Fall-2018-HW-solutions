...
def main():
    ...
    with sess.as_default():
        ...
        if args.num_training_rollouts == False:
            base_out_dir = GlobalDefs.clone_results_folder
        else:
            base_out_dir = os.path.join(GlobalDefs.rollout_base, '%d'%(args.num_training_rollouts),GlobalDefs.clone_results_folder)
